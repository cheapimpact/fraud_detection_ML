...
def main():
    ...
    # 1. Memuat Dataset
    file_path = '/Users/calcifer/Documents/MDMA/olah/model 2 MSC var  Oke/Dataset_ML_Ready_CLEAN_2.xlsx'
    try:
    ...
    X_mscore = ['DSRI', 'GMI', 'AQI', 'SGI', 'DEPI', 'SGAI', 'LVGI', 'TATA']
    ...
    export_path = '/Users/calcifer/Documents/MDMA/olah/model 2 MSC var  Oke/Hasil_Perbandingan_63_Skenario.xlsx'
