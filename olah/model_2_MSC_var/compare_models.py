...
def main():
    ...
    df = pd.read_excel('/Users/calcifer/Documents/MDMA/olah/model 2/Dataset_ML_Ready_CLEAN_2.xlsx')
    ...
    plt.tight_layout()
    plt.savefig('/Users/calcifer/Documents/MDMA/olah/model 2/model3_shap_summary.png', dpi=300)
    print("=> Plot SHAP Summary telah berhasil disimpan sebagai 'model3_shap_summary.png' di folder 'olah/model 2'.")
