...
def main():
    ...
    df = pd.read_excel('/Users/calcifer/Documents/MDMA/olah/model 3/Dataset_ML_Ready_CLEAN_3.xlsx')

    print("\n" + "="*50)
    print("1. Analisis Deskriptif")
    print("="*50)
    features_desc = ['M_Score', 
    ...
    # Evaluate Model 2
    _, y_pred2, metrics2 = evaluate_model(X2_cols, "Model 2")
    print(f"\nModel 2 (Replikasi Jurnal) metrics:\n {metrics2}")
    ...
    print("\n" + "="*50)
    print("3. Uji Signifikansi (McNemar's Test) - Model 2 vs Model 3")
    print("="*50)
    ...
    if result.pvalue < 0.05:
        print("=> Kesimpulan: Perbedaan prediksi antara Model 2 dan Model 3 SIGNIFIKAN secara statistik (p < 0.05).")
    else:
        print("=> Kesimpulan: Perbedaan prediksi antara Model 2 dan Model 3 TIDAK SIGNIFIKAN secara statistik (p >= 0.05).")
    ...
    plt.tight_layout()
    plt.savefig('/Users/calcifer/Documents/MDMA/olah/model 3/model3_shap_summary.png', dpi=300)
    print("=> Plot SHAP Summary telah berhasil disimpan sebagai 'model3_shap_summary.png' di folder 'olah/model 3'.")
